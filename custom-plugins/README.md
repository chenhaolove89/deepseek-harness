...
| dsh-git | Codex 式 Git 管理 v1.0：20 个 git 工具（只读/写/网络/危险确认/AI 提交信息）+ 15 RPC + Git 管理面板（侧边栏/输入框入口，overlay 浮层）+ 设置页 | **已静态化常驻** → `packages/client/git`（web-app 组合挂载，含 Git 设置页） | — |
